...
def prepare_dataloader(opt):
    ...
    train_data, num_types = load_data(opt.data + 'train_E.pkl', 'train')
    print('[Info] Loading dev data...')
    dev_data, _ = load_data(opt.data + 'dev_E.pkl', 'dev')

    trainloader = get_dataloader(train_data[0:300], opt.batch_size, shuffle=True)
    testloader = get_dataloader(dev_data[0:100], opt.batch_size, shuffle=False)
