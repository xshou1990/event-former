...
def prepare_dataloader(opt,seed):
   ...
   # print('[Info] Loading train data...')
    train_data, num_types = load_data(opt.data + 'train_ABCD.pkl', 'train')
   # print('[Info] Loading dev data...')
    dev_data, _ = load_data(opt.data + 'dev_ABCD.pkl', 'dev')


    trainloader = get_dataloader(train_data[0:1500], opt.batch_size, shuffle=True, seed=seed)
    devloader = get_dataloader(dev_data[0:500], opt.batch_size, shuffle=False, seed=seed)
