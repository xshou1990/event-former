...
def prepare_dataloader(opt):
    ...
    test_data, num_types = load_data(opt.data + 'test_E.pkl', 'test')

    testloader = get_dataloader(test_data[0:100], opt.batch_size, shuffle=False)
...
# parsed_args.data = "targetdata/hawkes/hawkes_exp/sample_5/"
# parsed_args.pretrain_model = "saved_models/hawkes_exp/2000woh/pretrain_novoid_batch32_mask15_11"  # pretrain model
# parsed_args.save_model="saved_models/hawkes_exp/pretrained/2000woh/s5_transfer_novoid_batch32_mask15_11" # pretrain model dict
parsed_args.data = "targetdata/gems/pgem/sample_5/"
parsed_args.pretrain_model = "saved_models/pgem/2000woe/pretrain_rand_batch32_mask15_11"  # pretrain model
parsed_args.save_model="saved_models/pgem/pretrained/2000woe/s5_transfer_rand_batch32_mask15_11_2lr" # pretrain model dict
parsed_args.batch_size = 1
parsed_args.smooth = 0.0
